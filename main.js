...
Mirage Lake Bldg Metal Const Ind. LLC
Your Trusted Partner in Construction and Building Solutions
...
// JavaScript Document
        ...
        const imageData = [
            {
                ...
                description: "Innovative building solutions with cutting-edge facade systems"
            },
            {
                title: "Facade Systems",
                description: "Unitized and stick curtain wall systems for modern architecture"
            },
            {
                title: "Door Solutions",
                description: "Automatic and manual doors for commercial and residential projects"
            },
            {
                title: "Glass & Enclosures",
                description: "Premium glass solutions including handrails and shower enclosures"
            },
            {
                title: "Handrails & Balustrades",
                description: "Stainless steel and aluminum handrails for safety and aesthetics"
            },
            {
                title: "Outdoor Structures",
                description: "Aluminum pergolas, carshades, and fencing gates"
            },
            {
                title: "Project Excellence",
                description: "Delivering quality construction projects across the UAE"
            }
        ];
        ...
        function handleSubmit(event) {
            ...
            alert('Thank you for your inquiry! Our team will contact you within 24 hours to discuss your construction project.');
            event.target.reset();
        }
